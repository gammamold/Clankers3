/**
 * Rhodes AudioWorkletProcessor — Clankers 3  (stereo output)
 *
 * Real-time streaming Rhodes FM piano. Brightness, tremolo, chorus update live.
 *
 * Messages IN:
...
registerProcessor('rhodes-worklet', RhodesWorkletProcessor);
