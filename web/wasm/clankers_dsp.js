...
export class ClankersBass {
     ...
     * @param {number} velocity
     * @param {number} hold_samples
     * @param {number} glide_samples
     * @param {string} cc_json
     */
    trigger_slide(midi_note, velocity, hold_samples, glide_samples, cc_json) {
        const ptr0 = passStringToWasm0(cc_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.clankersbass_trigger_slide(this.__wbg_ptr, midi_note, velocity, hold_samples, glide_samples, ptr0, len0);
    }
}
