...
export class ClankersBass {
     ...
     */
    trigger_slide(midi_note: number, velocity: number, hold_samples: number, glide_samples: number, cc_json: string): void;
}
...
export interface InitOutput {
    ...
    readonly clankersbass_trigger_slide: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
